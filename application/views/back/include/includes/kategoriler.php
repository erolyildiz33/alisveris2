...
<script type="text/javascript">
    ...
    $(document).on('click', '.yeniekle', function () {
        ...
        var ekle = '<div class="row">' +
            ...
            '<div class="form-label-group in-border">' +
            '<input class="form-control" id="title" placeholder="Kategori Adı" name="title" autocomplete="off">' +
    ...
    $(document).on('click', '.altguncelle', function () {
        ...
        var ekle = '<div class="row">' +
            ...
            '<div class="form-group">' +
            '<div class="form-label-group in-border">' +
            '<input class="form-control" placeholder="Alt Kategori Adı" id="title" name="title" autocomplete="off" value="' + title + '">' +
            '<label for="title">Alt Kategori Adı</label>' +
            '</div>' +
            '</div></div></div></div></div>';
